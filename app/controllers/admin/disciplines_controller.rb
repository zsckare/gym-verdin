class Admin::DisciplinesController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @discipline.save
        format.html { redirect_to admin_disciplines_path, notice: 'Se ha creado la disciplina.' }
  ...
  def update
    respond_to do |format|
      if @discipline.update(discipline_params)
        format.html { redirect_to admin_disciplines_path, notice: 'Discipline was successfully updated.' }
